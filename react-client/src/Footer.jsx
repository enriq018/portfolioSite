  ...
  <footer className="footer">
    <div className="container is-fluid">
      ...
      <div className="content has-text-centered">
        ...
        <p className="contactInfoContent "> Javier Enriquez | jav.enriquez@gmail.com | (760) 613-2781   </p>
        <h5> <strong>Jump to: </strong>  <a onClick={() => moveToLink('Landing')}>Landing</a> |
    ...
    <div className="content has-text-centered">
                    <a className= "button is-dark is-large is-4" >
