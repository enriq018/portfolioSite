...
const ModalTwo = props => (
  <div className={props.status ? "modal is-active" : "modal"}>
    ...
    <div className="modal-content modal2">
      <img
        src="https://javier-enriquez.000webhostapp.com/sys_architecture_v3.png"
        alt=""
      />
    </div>
    <button
  ...
  <div onClick={() => props.close()}>
    ...
    <div className="container is-fluid">
      <div className="columns">
        <div className="column">
          <img
            className="tilePic"
            src="https://javier-enriquez.000webhostapp.com/user_arch.png"
            alt=""
          />
        ...
        <div className="column is-one-third">
          <img
            className="tilePic"
            src="https://javier-enriquez.000webhostapp.com/dbSchema.png"
            alt=""
          />
    ...
    <section className="section section-dark">
      ...
      <h4 className="has-text-left has-text-white-ter words">
        ...
        <strong className="has-text-white has-text-weight-bold bigText">
          {" "}
          relational database{" "}
        </strong>{" "}
    ...
    <div className="container">
      <div className="columns is-centered">
        <div className="column is-narrow">
          <h1 className="title has-text-black has-text-centered	is-1 is-italic has-text-weight-bold">
            Artillery Stress Testing
          </h1>

          <img
            className="art"
            src="https://javier-enriquez.000webhostapp.com/artileryComparison2.png"
            alt=""
          />
        </div>
      </div>
    ...
    <section className="section section-dark">
      <h4 className="has-text-left has-text-white-ter words">
        ...
        <strong className="has-text-warning has-text-weight-bold bigText">
          {" "}
      ...
      <br />
      <h4 className="has-text-left has-text-white-ter words">
        My main optimization came from restructuring my MariaDb database schema
        to incorporate
        <strong className="has-text-white has-text-weight-bold bigText">
          {" "}
          indexing
        ...
        which was well within my teams goal.
      </h4>
      <br />
    </section>
